...
from cyber.models.world.autoencoder.cosmos_tokenizer.modules.layers3d import CausalConv3d
from cyber.models.world.autoencoder.cosmos_tokenizer.modules.quantizers import InvQuantizerJit
...
class CausalDiscreteVideoTokenizer(nn.Module):
    def __init__(self, z_channels: int, z_factor: int, embedding_dim: int, **kwargs) -> None:
        ...
        if quantizer_name == DiscreteQuantizer.VQ.name:
            ...
            kwargs.update(dict(embedding_dim=embedding_dim))  # noqa: C408
    ...
    def to(self, *args, **kwargs):
        self.quantizer.dtype = kwargs.get("dtype", torch.float32)
    ...
    def forward(self, input_tensor):
        quant_info, quant_codes, quant_loss = self.encode(input_tensor)
