...
from cyber.models.world.autoencoder.cosmos_tokenizer.modules.patching import (
    Patcher,
    Patcher3D,
    UnPatcher,
    UnPatcher3D,
...
class CausalConv3d(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        # ! added more type checking for kernel_size
    ...
    def _replication_pad(self, x: torch.Tensor) -> torch.Tensor:
        ...
        padding = self.spatial_pad + (0, 0)  # noqa: RUF005
