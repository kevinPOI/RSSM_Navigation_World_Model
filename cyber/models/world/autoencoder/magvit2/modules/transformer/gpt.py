...
class GPT(nn.Module):
    def __init__(
        ...
        self.config = GPTConfig(
            ...
            spatial_n_layer=spatial_n_layer,
...
@torch.no_grad()
def sample(x, model, steps, temperature=1.0, sample_logits=True, top_k=None, top_p=None, callback=None, token_factorization=True, cfg_scale=1.0):
